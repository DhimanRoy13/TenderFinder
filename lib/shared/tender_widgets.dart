...
// InfoRow widget for displaying label-value pairs
...
class TenderCard extends StatelessWidget {
  ...
  void _handleTenderTap(BuildContext context) {
    ...
    if (subscriptionProvider.isSubscribed) {
      ...
      Navigator.push(
        context,
        MaterialPageRoute(builder: (_) => TenderDetailScreen(tender: tender)),
      );
    } else {
      // User doesn't have subscription, show subscription screen
      Navigator.push(
        context,
        MaterialPageRoute(
        ...
        // If user subscribed successfully, navigate to tender details
        if (subscribed == true) {
          Navigator.push(
            context,
            MaterialPageRoute(
  ...
  Widget build(BuildContext context) {
    return Consumer<SubscriptionProvider>(
      builder: (context, subscriptionProvider, _) {
        return GestureDetector(
          onTap: () => _handleTenderTap(context),
          child: Container(
            decoration: BoxDecoration(
              color: Colors.white,
            ...
            child: Stack(
              children: [
                // Show lock icon overlay if not subscribed
                if (!subscriptionProvider.isSubscribed)
                  Positioned(
                    top: 0,
                    right: 0,
                  ...
                  children: [
                    ...
                    SizedBox(
                      ...
                      child: ElevatedButton(
                        onPressed: () => _handleTenderTap(context),
                        style:
                        ...
                        child: Ink(
                          decoration: BoxDecoration(
                            gradient: subscriptionProvider.isSubscribed
                                ...
                                : const LinearGradient(
                                    colors: [Colors.orange, Color(0xFFE65A00)],
                                    begin: Alignment.centerLeft,
                                    end: Alignment.centerRight,
                                  ),
          ...
          ), // Close the Container (child of GestureDetector)
        ); // Close the GestureDetector
      },
    );
  } // Close the build method
} // Close the TenderCard class
                              ...
                              child: Column(
                                children: [
                                  ...
                                  _MultiSelectCategoryDropdown(
                                    ...
                                    options: const ['Sector 1', 'Sector 2'],
                                    selected:
                                        _filters['Sector'] == null ||
                                            _filters['Sector']!.isEmpty
                                        ? []
                                        : _filters['Sector']!
                                              .split(',')
                                              .map((e) => e.trim())
